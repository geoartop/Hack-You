...
να το βγαλω δεν εχει ολες τις εντολες για το animasion μεσα)
...
import java.awt.event.KeyListener;
 ...
 ειναι 5 το πρωι ασχολουμε με αυτο 6 ωρες καληνυχτα  αυριο εχουμε υπνο στις βασεις και τον σπανακη να φωναζει που χανει στο ταβλι*/
